...
test "complex: create" {
    ...
    const expr = try h.parseExpr(allocator, "(complex 3 4)");
    defer {
...
test "complex: real part" {
    ...
    const expr = try h.parseExpr(allocator, "(real (complex 3 4))");
    defer {
        expr.deinit(allocator);
        allocator.destroy(expr);
    }
...
test "complex: imag part" {
    ...
    const expr = try h.parseExpr(allocator, "(imag (complex 3 4))");
    defer {
        expr.deinit(allocator);
        allocator.destroy(expr);
    }
...
test "complex: conjugate" {
    ...
    const expr = try h.parseExpr(allocator, "(conj (complex 3 4))");
    defer {
        expr.deinit(allocator);
        allocator.destroy(expr);
    }
...
test "complex: magnitude" {
    ...
    const expr = try h.parseExpr(allocator, "(magnitude (complex 3 4))");
    defer {
        expr.deinit(allocator);
        allocator.destroy(expr);
    }
