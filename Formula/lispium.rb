class Lispium < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/Tetraslam/lispium/releases/download/v0.7.0/lispium-macos-aarch64.tar.gz"
      sha256 "5432521b213b6bb2cd1aa5c633f9cee19acee9180f28117dfb53288cb1fcb8f7"
    end
    on_intel do
      url "https://github.com/Tetraslam/lispium/releases/download/v0.7.0/lispium-macos-x86_64.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/Tetraslam/lispium/releases/download/v0.7.0/lispium-linux-aarch64.tar.gz"
      sha256 "afd9b702f84607ad744ea7a0b4b83c6fce2b1c5b17974f1f2b22d159d0ae7b07"
    end
    on_intel do
      url "https://github.com/Tetraslam/lispium/releases/download/v0.7.0/lispium-linux-x86_64.tar.gz"
